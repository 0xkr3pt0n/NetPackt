    ...
    def onlineSearch(self, infodisplay, scan_id):
        for record in infodisplay:
            ...
            for keys, values in cves.items():
                ...
                insert_query = "INSERT INTO api_result (cve_id, refrences, nvd, description, infected_service, scan_id, impact) VALUES (%s, %s, %s, %s, %s, %s, %s)"
                values = (cveid, refrences, nvd_ref, description, infected, scan_id, impact)
